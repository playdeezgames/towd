Friend Class KnappingSkillTypeDescriptor
    ...
    Public Sub New()
        MyBase.New(data.SkillType.Knapping, "Knapping", business.StatisticType.KnappingSkill, 1, "Unleash the ancient craft of knapping in the Tomb of Woeful Doom’s unforgiving wilds.
