Friend Class KnappingSkillTypeDescriptor
    ...
    Public Sub New()
        MyBase.New(
            business.SkillType.Knapping,
            "Knapping",
            business.StatisticType.KnappingSkill,
            1,
            "Unleash the ancient craft of knapping in the Tomb of Woeful Doom’s unforgiving wilds.
...
Higher levels forge deadly edges; low rolls might just bruise your pride.",
            {Deed.CompleteKnapperQuest.ToDeedDescriptor})
    End Sub
