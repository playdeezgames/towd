Friend Class ChopSkillTypeDescriptor
    ...
    Public Sub New()
        MyBase.New(data.SkillType.Chop, "Chop", data.StatisticType.ChopSkill, 5, "The ""Chop"" skill lets you hack through wood, branches, and the occasional unlucky sapling with brutal efficiency, turning nature’s bounty into crafting materials or kindling for your pathetic campfire. 
