Friend Class FishSkillTypeDescriptor
    ...
    Public Sub New()
        MyBase.New(business.SkillType.Fish, "Fish", business.StatisticType.FishSkill, 5, "With the Fish skill, you stand at the edge of a murky pond, clutching your tattered fishing net like it's the last shred of hope in this godforsaken wasteland. 
