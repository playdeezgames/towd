Friend Class ForagingSkillTypeDescriptor
    ...
    Public Sub New()
        MyBase.New(data.SkillType.Foraging, "Foraging", business.StatisticType.ForagingSkill, 5, "Master the art of scavenging in the Tomb of Woeful Doom’s bleak sprawl.
