Friend Class DigSkillTypeDescriptor
    ...
    Public Sub New()
        MyBase.New(data.SkillType.Dig, "Dig", business.StatisticType.DigSkill, 5, "With a gritty determination and a complete disregard for manicured nails, the Dig skill lets you claw through the earth like a nihilistic badger. 
