function love.conf(t)
    t.identity = "towd"                 -- The name of the save directory (string)
    ...
    t.window.title = "Tomb of Woeful DOOM!"         -- The window title (string)
    t.window.icon = "Icon.bmp"                 -- Filepath to an image to use as the window's icon (string)
