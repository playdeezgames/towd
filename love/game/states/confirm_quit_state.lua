...
function M.new(parent)
    local NO_TEXT = "No"
    local YES_TEXT = "Yes"
    local instance = picker_state.new(parent, image_id.SPLASH, font_id.M6X11PLUS_48, "Are you sure you want to quit?", {NO_TEXT, YES_TEXT}, {caption_hue = hues.LIGHT_RED, caption_shadow_hue=hues.RED})
